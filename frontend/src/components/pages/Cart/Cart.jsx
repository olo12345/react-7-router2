...
function Cart() {
    ...
    const { cart, total, restarCount, sumarCount } = useContext(CartContext)
    ...
    return (
        <>
            ...
            <button disabled={!token} className="bg-blue-500 disabled:bg-gray-500 text-white mx-5 my-2 py-1 rounded-lg hover:bg-blue-600 transition duration-300 w-16 h-8">Pagar</button>
        </>
    )
}
